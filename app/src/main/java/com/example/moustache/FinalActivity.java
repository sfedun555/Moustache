...
public class FinalActivity extends AppCompatActivity {
    ...
    private void revealLetter (char letter){
        ...
        while (indexOfLetter >= 0) {
            ...
            MediaPlayer right = MediaPlayer.create(FinalActivity.this, R.raw.zvuk_pravilno_ugadannoy_bukvyi_pole_chudes_5206);
            right.start();
            count++;
        }
        res = res * count;
    ...
    private void ifLetterCorrect (char letter){
        ...
        if (ans.indexOf(L) >= 0) {
            ...
            if (ansDisp.indexOf(L) < 0) {
                ...
                if (!ansDisp.contains("*")) {
                    MediaPlayer win = MediaPlayer.create(FinalActivity.this, R.raw.zvuk_otgadannogo_slova_v_ture_5235);
                    win.start();
 ...
 */
                ...
                MediaPlayer wrong = MediaPlayer.create(FinalActivity.this, R.raw.zvuk_nepravilnoy_bukvyi_v_pole_chudes_nevernyiy_otvet_5212);
                wrong.start();
                res = 0;
            }
        } else {
    ...
    private int getResult (int curDegree){
        MediaPlayer prize = MediaPlayer.create(FinalActivity.this, R.raw.sektor_priz_na_barabane_5216);
        MediaPlayer chance = MediaPlayer.create(FinalActivity.this, R.raw.sektor_shans_na_barabane_zvonok_po_telefonu_5220);
        MediaPlayer zero = MediaPlayer.create(FinalActivity.this, R.raw.u_vas_nol_perehod_hoda_na_drugogo_uchastnika_5218);
        MediaPlayer bankrupt = MediaPlayer.create(FinalActivity.this, R.raw.vyi_bankrot_5217);
        MediaPlayer plus = MediaPlayer.create(FinalActivity.this, R.raw.vyipal_sektor_plyus_5225);
        MediaPlayer x2 = MediaPlayer.create(FinalActivity.this, R.raw.zvuk_vyipalo_na_barabane_h2_umnojenie_ochkov_v_2_raza_5229);
        ...
        wordBtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if (wordEt.getText().toString().toUpperCase().equals(a[i])) {
                    MediaPlayer corWord = MediaPlayer.create(FinalActivity.this, R.raw.zvuk_otgadannogo_slova_v_ture_5235);
                    corWord.start();
                    scores += 5000;
...
*/
        ...
        spinBtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                MediaPlayer music = MediaPlayer.create(FinalActivity.this, R.raw.zvuk_vrascheniya_barabana_peredacha_1995_goda_5224);
